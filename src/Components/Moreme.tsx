      ...
      <div className="moreme-red-area">
        <div className="moreme-text-links-box">
          ...
          <div className="moreme-links">
            <a href="https://github.com/Looseman1212" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                className="moreme-svg"
              >
            ...
            <a
              href="https://www.linkedin.com/in/max-reid-4621a9257/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.instagram.com/yeahsickg/" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                className="moreme-svg"
